  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex items-center pt-24 pb-12 lg:pt-20 overflow-hidden bg-[#0B0C15]">
      ...
      <div className="absolute inset-0 pointer-events-none">
         ...
         <div className="absolute top-0 right-0 w-[300px] lg:w-[800px] h-[300px] lg:h-[600px] bg-primary/10 rounded-full blur-[80px] lg:blur-[120px] mix-blend-screen" />
         <div className="absolute bottom-0 left-0 w-[300px] lg:w-[600px] h-[300px] lg:h-[600px] bg-purple-900/10 rounded-full blur-[80px] lg:blur-[120px] mix-blend-screen" />
      </div>
