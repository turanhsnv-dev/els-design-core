  ...
  return (
    <section id="impact" className="relative w-full bg-background-dark overflow-hidden">
      ...
      <Container className="py-14 md:py-24 lg:py-32">
        ...
        <RevealContainer
          className="grid grid-cols-2 lg:grid-cols-4 border border-white/6 rounded-2xl overflow-hidden mb-6"
          stagger={0.08}
        >
          {METRICS.map((metric, i) => (
            <RevealItem
              key={i}
              className={`group relative p-5 sm:p-7 md:p-10 flex flex-col justify-between min-h-42.5 md:min-h-52.5 bg-[#0e0e13] hover:bg-[#111118] transition-colors duration-700 ${
            ...
            >
              ...
              <div>
                <p className="text-sm font-semibold text-white/80 mb-2 uppercase tracking-wider">
                  {metric.label}
                </p>
